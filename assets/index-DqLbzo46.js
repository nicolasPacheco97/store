...
const MyApp = lazy(
  () => __federation_method_getRemote("productApp" , "./App").then(module=>__federation_method_wrapDefault(module, true)).catch(
    (error) => {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "App - root" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MyApp, {})
  ] });
}
function AppDefault() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Oppss.. Something wrong" }) });
}
