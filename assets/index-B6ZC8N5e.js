...
function useResolvedPath(to, _temp2) {
  ...
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches, future.v7_relativeSplatPath));
  return React$4.useMemo(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to, routePathnamesJson, locationPathname, relative]);
}
...
const Link = /* @__PURE__ */ React$3.forwardRef(function LinkWithRef(_ref7, ref) {
  ...
  return (
    ...
    /* @__PURE__ */ React$3.createElement("a", _extends$1({}, rest, {
...
const logo = "/store/assets/teapot-e-wVS4L-.png";
...
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "flex justify-center z-20 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "w-full max-w-[1280px] px-5 flex justify-between items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, className: "w-14 md:w-20" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 text-lg font-medium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(IoSearch, { cursor: "pointer", size: 25 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "product", children: "Product" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { children: "Sing in" })
    ] })
  ] }) });
}
...
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl", children: "Oppss.. Something wrong" });
}

const {lazy} = await importShared('react');

const MyApp = lazy(() =>
  __federation_method_getRemote("productApp" , "./App").then(module=>__federation_method_wrapDefault(module, true)).catch(getModuleError));
...
function Product() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: "Loading...", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MyApp, {}) });
}

const artVideo = "/store/assets/art-DZuCAOt9.mp4";

function CenterInfo({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center w-full h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[1280px] px-3 md:px-0 py-4 h-full", children }) });
}

function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full z-0 absolute top-0 right-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("video", { className: "w-full h-screen object-cover", muted: true, playsInline: true, autoPlay: true, loop: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("source", { src: artVideo, type: 'video/mp4; codecs="avc1"' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Your browser cannot play the provided video file." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full z-10 absolute top-0 right-0 backdrop-brightness-75 h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CenterInfo, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-[30%] text-white h-fit", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl md:text-7xl font-extrabold", children: [
        "Nuevos productos ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        " para tu arte"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-normal", children: "Se tu propio artista" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/store/product", className: "rounded-full border-white border-2 py-3 px-6 my-2", children: "Ir al catálogo" })
    ] }) }) }) })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) });
}
