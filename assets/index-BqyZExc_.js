...
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b-2 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "w-full max-w-[1500px] px-5 flex justify-between items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, className: "w-20 md:w-28" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 text-xl font-medium", children: [
